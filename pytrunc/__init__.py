...
Provides
  1. Analytic scattering phase functions: Henyey-Greenstein, two-term
     Henyey-Greenstein and Fournier-Forand
  2. Phase function Legendre moments, computed numerically for an
     arbitrary phase function or analytically for the Henyey-Greenstein
     family
  3. Truncation methods: the delta-m method and the Iwabuchi GT method

How to use the documentation
----------------------------
Documentation is available in two forms: docstrings provided with the
code, and a standalone reference guide, available from
`the pytrunc homepage <https://hygeos.github.io/pytrunc/>`_.
